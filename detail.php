...
<head>
  ...
  <title>Al-Qur'an Digital | TertandaID</title>
  <style>
    @font-face {
      font-family: 'Uthmani';
      /* src: url('assets/font/Mcs_Swer_Al_Quran_2.ttf') format("truetype"); */
      src: url('assets/font/NotoNaskhArabic-Regular.ttf') format('truetype');
    }
